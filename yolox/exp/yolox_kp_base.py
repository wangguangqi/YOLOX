...
class KP_Exp(BaseExp):
    def __init__(self):
        ...
        # ---------------- model config ---------------- #
        # write pose object labels
        self.pose_obj = True  
        # detect classes number of model
        # number of classes (person class + 17 keypoint classes)
        self.num_classes = 18
         # number of keypoint coordinates (x, y)
        self.num_coords = 34  
        ...
        self.kp_flip = [0, 2, 1, 4, 3, 6, 5, 8, 7, 10, 9, 12, 11, 14, 13, 16, 15]
        # left keypoints
